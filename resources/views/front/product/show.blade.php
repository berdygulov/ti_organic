...
@section('content')
    ...
    <section class="product">
        <div class="container">
            <div class="product-inner">
                <div class="mb-7.5 xl:mb-0 lg:mr-25 product-left">
                ...
                <div>
                    <div>
                        <h5 class="lg:mb-8.5 mb-6.5">Увлажняющая маска Yves Rocher</h5>
                        <div>
                        ...
                        <div class="lg:mt-8.5 mt-6.5 flex items-end mb-[40px] lg:mb-12.5">
    ...
    <section class="mt-23 lg:mt-[110px]">
        <div>
            <div class="container">
